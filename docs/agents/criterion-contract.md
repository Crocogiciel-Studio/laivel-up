...
applies_to: "packages/core/src/criteria/**,packages/core/src/core/ports/criterion-evaluator.ts,packages/core/src/core/engine/**"
...
`packages/core/src/criteria/harness/tooling-context-depth.ts` (single-source) and `packages/core/src/criteria/size/pr-feature-size.ts`
(two families). The interface itself: `packages/core/src/core/ports/criterion-evaluator.ts`.
...
`packages/core/src/core/engine/evaluate.ts` turns a missing section into an `unknown` reading.
...
Reference: `packages/core/src/core/engine/evaluate.ts`.
...
the model. Reference: `packages/core/src/core/engine/confidence.ts`.
...
`packages/core/src/core/engine/bundle.ts`; the `min(tierA, tierB)` reconciliation in `pr-feature-size.ts`.
